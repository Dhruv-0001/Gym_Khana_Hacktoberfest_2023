blogs = [
    {
        title: "How to Build the Habit of Exercising",
        src: "https://th.bing.com/th/id/OIP.8nYaHEzHOviVnqmGq_ANVgHaLH?pid=ImgDet&rs=1",
        excerpt: "Learn effective strategies to build a consistent exercise routine and achieve your fitness goals.",
        content: `
        <p><strong>How to Build the Habit of Exercising</strong></p>
        <p>Exercise is essential for a healthy lifestyle, but establishing a consistent workout routine can be challenging. In this blog post, we'll explore effective strategies to help you build the habit of exercising.</p>
        <p><strong>Introduction:</strong> Building the habit of exercising is crucial for maintaining a healthy lifestyle. We often start with enthusiasm but struggle to stick with it. However, with the right approach, exercise can become a natural part of your daily routine.</p>
        <ol>
          <li><strong>Set Realistic Goals:</strong> Start with small, manageable targets, and gradually increase the intensity and duration of your workouts. Realistic goals make it easier to stay committed.</li>
          <li><strong>Create a Consistent Schedule:</strong> Consistency is key to forming a habit. Choose specific times each day or certain days of the week for your workouts. Treat these appointments with the same importance as any other commitments in your life.</li>
          <li><strong>Find Activities You Enjoy:</strong> Exercise doesn't have to be boring. Discover physical activities that you genuinely enjoy, whether it's dancing, hiking, swimming, or playing sports. Having fun while working out increases your chances of sticking to your routine.</li>
          <li><strong>Stay Accountable:</strong> Share your fitness goals with a friend or family member who can help keep you accountable. Having a workout buddy can provide motivation and encouragement. You can also track your progress using a fitness app or journal to celebrate your achievements.</li>
        </ol>
    ...
    {
        title: "How to be fit",
        src: "https://www.medicineandnutrition.org/wp-content/uploads/2020/07/Top-7-Home-Exercises-to-Get-Fit-Fast100.jpeg",
        excerpt: "Discover a selection of the most effective exercises to improve your overall fitness and strength.",
        content: `
            <p>Getting fit requires a well-rounded exercise routine. In this blog post, we'll introduce you to some of the best exercises that can help you achieve your fitness goals. From cardiovascular workouts to strength training exercises, you'll find a variety of options to suit your preferences and needs.</p>
            <p><strong>Cardiovascular Workouts:</strong></p>
            <p>Cardio exercises are great for improving your heart health and burning calories. Activities like running, cycling, and swimming can get your heart rate up and boost your endurance. Aim for at least 150 minutes of moderate-intensity cardio each week.</p>
            <hr>
            <p><strong>Strength Training:</strong></p>
            <p>Strength training exercises, such as weightlifting and bodyweight exercises, help build muscle mass and increase metabolism. Incorporate strength training into your routine at least two days a week, targeting different muscle groups.</p>
            <hr>
            <p><strong>Flexibility and Stretching:</strong></p>
            <p>Don't forget about flexibility! Stretching exercises like yoga and Pilates can improve your range of motion and reduce the risk of injuries. Try to stretch for 10-15 minutes every day.</p>
            <p><strong>Healthy Eating:</strong></p>
            <p>Exercise alone isn't enough. Pair your workouts with a balanced diet. Focus on whole foods, lean proteins, fruits, vegetables, and stay hydrated. Proper nutrition is essential for your fitness journey.</p>
            <hr>
            <p><strong>Rest and Recovery:</strong></p>
            <p>Rest is crucial for muscle recovery. Ensure you get 7-9 hours of quality sleep each night. Additionally, allow your muscles to recover by having rest days in your workout schedule.</p>
